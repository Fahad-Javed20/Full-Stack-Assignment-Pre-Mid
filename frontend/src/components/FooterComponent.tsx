      ...
      <div style={{  color: '#213448' }} className=" bg-whitecontainer mx-auto px-5 py-10">
        <div className="flex flex-wrap justify-between text-sm">
          ...
          <div className="w-full sm:w-1/2 md:w-1/6 mb-6">
            ...
            <ul className="space-y-2">
              <li><a href="" className="hover:opacity-80">Features</a></li>
              <li><a href="" className="hover:opacity-80">Pricing</a></li>
              <li><a href="" className="hover:opacity-80">Integrations</a></li>
              <li><a href="" className="hover:opacity-80">Updates</a></li>
            </ul>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/6 mb-6">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="" className="hover:opacity-80">API Reference</a></li>
            </ul>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/6 mb-6">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="" className="hover:opacity-80">Report Issue</a></li>
              <li><a href="" className="hover:opacity-80">System Status</a></li>
            </ul>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/6 mb-6">
          ...
          <div className="w-full sm:w-1/2 md:w-1/6 mb-6">
            ...
            <ul className="space-y-2">
              <li><a href="" className="hover:opacity-80">Email Us</a></li>
              <li><a href="" className="hover:opacity-80">Live Chat</a></li>
              <li><a href="" className="hover:opacity-80">Office Locations</a></li>
